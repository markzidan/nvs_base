...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('aos'), require('jquery'), require('flickity'), require('isotope-layout'), require('jarallax'), require('scrollmonitor'), require('smooth-scroll'), require('@tanem/svg-injector')) :
  typeof define === 'function' && define.amd ? define(['exports', 'aos', 'jquery', 'flickity', 'isotope-layout', 'jarallax', 'scrollmonitor', 'smooth-scroll', '@tanem/svg-injector'], factory) :
  (global = global || self, factory(global.theme = {}, global.AOS, global.jQuery, global.Flickity, global.Isotope, global.jarallax, global.scrollMonitor, global.SmoothScroll, global.SVGInjector));
}(this, function (exports, AOS, jQuery$1, flickity, Isotope, jarallax, scrollMonitor, SmoothScroll, svgInjector) { 'use strict';
